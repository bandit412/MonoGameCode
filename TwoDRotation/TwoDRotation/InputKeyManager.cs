...
namespace TwoDRotation
{
    static class InputKeyManager
    {
        ...
        public enum Triggers : ulong
        {
            ...
            CW         = 0x0000000000000200,
            CCW        = 0x0000000000000400,
            Center     = 0x0000000000000800,
            Origin     = 0x0000000000001000
        ...
        static public Triggers Read()
        {
            ...
            if (keyboardState.IsKeyDown(Keys.Add))
                currentKeyState |= Triggers.CW;

            if (keyboardState.IsKeyDown(Keys.Subtract))
                currentKeyState |= Triggers.CCW;

            if (keyboardState.IsKeyDown(Keys.C))
                currentKeyState |= Triggers.Center;

            if (keyboardState.IsKeyDown(Keys.O))
                currentKeyState |= Triggers.Origin;
